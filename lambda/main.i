...
# 254 "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/include/stdlib.h" 2 3 4
...
# 255 "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/include/stdlib.h" 2 3 4
...
int main() {
    ...
    lambda_t tripler = ({ lambda_t l = { .func = multiple, .context = (void *) &mult}; l; });

    int i = ({ int i = 1 + 2; i;});

    printf("xxxxxxxxxxxxxx i: %d\n", i);
